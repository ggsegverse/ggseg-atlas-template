# Quick instructions for AI coding agents working on {REPO}
...
- `R/sysdata.rda` -- Unified `ggseg_atlas` objects (2D + 3D in one object)
- `R/data.R` -- Roxygen2 documentation for each atlas
- `R/{REPO}-package.R` -- Package-level docs, imports ggseg.formats
